...
int main(){
    ...
    //---------------------------------------------
	if(firstindexof7(arr,n,0)<0){
		cout<<"element is not present"<<endl;
	}
	else{
		cout<<"element is present at index "<<firstindexof7(arr,n,0)<<endl;
	}
    //---------------------------------------------
    if(last7index(arr,n,n-1)<0){
		cout<<"element is not present"<<endl;
	}
	else{
		cout<<"element is present at index "<<last7index(arr,n,n-1)<<endl;
	}
    //---------------------------------------------
	allindices(arr,n,0);
